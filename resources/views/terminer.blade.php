      ...
      <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title bg-success">Demande terminée</h3>
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <td>{{$list->motif}}</td>
                  <td>
                    <a class="nav-link" href="{{route('listTerminer')}}/{{ $list->slug}}">Voir</a>
                    <a class="nav-link" href="{{ $list->slug}}">Print<i class="fas fa-print ml-1"> </i></a>
                  </td>
                  </tr>
                  @endforeach
